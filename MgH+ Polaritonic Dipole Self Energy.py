...
# # MgH+ Polaritonic Dipole Self Energy 
# ## Authors: Ama Ameyaw, Carlos Davila, Griffin Ellis, Kami Hollingshead, and Oriana Silva
...
def Rabi_Hamiltonian(A_value, omega_value, r_value, g_spline, e_spline, tdm_spline):
    ...
    -------
    H : numpy array
        3x3 Rabi Hamiltonian matrix ---> Including the Dipole Self Energy
    """
    ...
    # Dipole Self Energy Calculation
    H[0,2] = 1/2 *(A_value* tdm_spline(r_value))**2
    H [2,0] = 1/2 *(A_value* tdm_spline(r_value))**2
    return H
